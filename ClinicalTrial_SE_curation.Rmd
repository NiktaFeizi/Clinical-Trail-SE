...
GSE15622_SE <- run_all(raw_tar = "GSE15622_RAW.tar" , 
                       ...
                       brain_path = "http://mbni.org/customcdf/24.0.0/ensg.download/hgu133a2hsensgcdf_24.0.0.tar.gz",
                       delim = "_.*" , GPL = "GPL8414", cancer_type=NA,treatment = "treatment.ch1", response = "response.ch1" , 
                       survival_type = NA, survival_time = NA,  
                       survival_time_unit= NA, event_occured = NA, delim2=".CEL")

colData(GSE15622_SE)[["cancer_type"]] <- "Ovarian Cancer"
colData(GSE15622_SE)[["survival_type"]] <- NA_character_
```
