...
---
#Please note:
Parameters of "run_all" function are data specific and must be defined by looking at the metadata outside of the function. 
...
```{r}
geo_rma<- function (raw_tar, geo_path , brain_path){
...
run_all <- function(raw_tar, geo_path, brain_path, delim, GPL, cancer_type ,treatment, response, survival_type,
...
```{r}
#==== 9 ====
GSE15622_SE <- run_all(raw_tar = "GSE15622_RAW.tar" , 
...
remotes::install_github("bhklab/AnnotationGx@development")
